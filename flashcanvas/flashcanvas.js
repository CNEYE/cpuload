(function(j, m) {
	...
	D.prototype = {
		...
		e: function(a) {
			...
			if (this.s !== this.shadowColor) {
				c = this.s = this.shadowColor; ("" + c).indexOf("%") > 0 && this.i.push(b.length + 1);
				b.push("W", c)
			}
	...
	z.prototype = {
		addColorStop: function(a, b) {
			...
			var c = this.O,
			d = this.id; ("" + b).indexOf("%") > 0 && c.i.push(c.a.length + 3);
			c.a.push("y", d, a, b)
		}
	};
	O.prototype = Error();
	...
	F = {
		initElement: function(a) {
			...
			a.toDataURL = function(i, s) {
				if (a.width === 0 || a.height === 0) return "data:,"; ("" + i).replace(/[A-Z]+/g, ha) === "image/jpeg" ? h.a.push("A", i, typeof s === "number" ? s: "") : h.a.push("A", i);
